async function getCurrentWeatherByCity(city) {
  ...
  const data = await fetch(`http://api.weatherapi.com/v1/current.json?key=11258e9fab32462abf9135015251612&q=${city}&aqi=no`)
...
async function getForecastByCity(city) {
  const data = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=11258e9fab32462abf9135015251612&q=${city}&days=1&aqi=no&alerts=no`)
  //const data = await fetch(`http://api.weatherapi.com/v1/current.json?key=11258e9fab32462abf9135015251612&q=${city}&aqi=no`)
